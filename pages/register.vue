  ...
  <div class="main">
    ...
    <div class="sign-up-container">
      <el-form ref="userForm" :model="params">
        ...
        <el-form-item class="input-prepend restyle" prop="username" :rules="[{ required: true, message: '请输入你的昵称', trigger: 'blur' }]">
          <div>
            <el-input type="text" placeholder="你的用户名" v-model="params.username"/>
    ...
    methods: {
      submitRegister(){
        this.$refs['userForm'].validate((valid) => {
          if (valid) {
            registerApi.doRegister(this.params).then(response => {
            this.$message({
              type: 'success',
              message: "注册成功"
            })
